1)This program is used to purchase the item and get the discounted bill
2)Defined 4 classes to achieve the problem using OOPS 
2)Item.java is the POJO class for the Item/product which is having name,price,quantity and type
